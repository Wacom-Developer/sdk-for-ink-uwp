...
namespace Wacom
{
	...
	{
		public static bool UseIntermediatePoints = true;

		public static void AddPointsFromEvent(this PointerDataProvider accumulator, Phase phase, PointerEventArgs args)
		{
		...
		public static void AddPointsFromEvent(this PointerDataProvider accumulator, Phase phase, UIElement uiElement, PointerRoutedEventArgs args)
		{
			if (UseIntermediatePoints)
			{
