...
{
    public class FeltTool : VectorDrawingTool
    {
        public FeltTool() : base("wdt:Felt")
        {
        ...
        public static PathPoint PenInputCalculator(PointerData previous, PointerData current, PointerData next)
        {
            ...
            float tiltScale = 1.0f + 2.0f * cosAltitudeAngle;
            float size = 0.8f + 2.0f * current.Force.Value;
