...
namespace Tutorial_02
{
	...
	/// </summary>
	public sealed partial class Part3 : Page
	{
		#region Fields

		private string _fileName = "strokes.will";
		...
		public Part3()
		{
			...
			Windows.UI.Core.SystemNavigationManager.GetForCurrentView().BackRequested += Part3_BackRequested;

			CreateWacomInkObjects();
		}

		private void Part3_BackRequested(object sender, Windows.UI.Core.BackRequestedEventArgs e)
		{
